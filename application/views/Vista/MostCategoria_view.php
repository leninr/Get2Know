							...
							<div class="container-fluid">
									<div class="row">
											<div class="col-md-12">
													<div class="card">
															<div class="header">
																	<h4 class="title" style="color:purple">Categorias</h4>
															</div>
																	...
																	<table class="table table-hover table-striped">
																			...
																			<tbody>
																				<?php foreach($Categorias as $Categoria) {?>
																					<tr>
																						<td>
																							<?php	echo $Categoria['NomCategoria'];?>
																						</td>
																						<td>
																							<a href="<?php echo site_url('categoria_ctrl/EditarCategoriaC/'.$Categoria['idCategoria']); ?>">Editar</a>
																						</td>
																						<td>
																							<a href="<?php echo site_url('categoria_ctrl/borrarCategoriaC/'.$Categoria['idCategoria']); ?>" style="color:red">Eliminar</a>
																						</td>
																					</tr>
																				<?php } ?>
																			</tbody>
