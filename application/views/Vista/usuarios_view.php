							...
							<div class="container-fluid">
									<div class="row">
											<div class="col-md-12">
													<div class="card">
															<div class="header">
																	<h4 class="title" style="color:purple">Usuarios</h4>
															</div>
																			...
																			<tbody>
																				<?php foreach($usuarios as $usuario) { ?>
																					<tr>
																						...
																						<td>
																							<a href="<?php echo site_url('user_ctrl/EditarUsuarioC/'.$usuario['idusuario']); ?>">Editar</a>
																						</td>
																						<td>
																							<a href="<?php echo site_url('user_ctrl/borrarUsuarioC/'.$usuario['idusuario']); ?>" style="color:red">Eliminar</a>
																						</td>
																					</tr>
																				<?php } ?>
																			</tbody>
